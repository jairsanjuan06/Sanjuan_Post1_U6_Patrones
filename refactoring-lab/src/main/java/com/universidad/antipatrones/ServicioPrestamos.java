...
/**
 * Clase especializada 3 — Responsabilidad: gestion de prestamos.
 *
 * SRP aplicado: esta clase solo cambia si cambian las reglas del negocio
 * de prestamo (ej: limite de libros por socio, fechas de vencimiento).
 *
 * Dependencias inyectadas por constructor: facilita pruebas unitarias
 * porque se pueden pasar mocks de CatalogoLibros y RegistroSocios.
 */
